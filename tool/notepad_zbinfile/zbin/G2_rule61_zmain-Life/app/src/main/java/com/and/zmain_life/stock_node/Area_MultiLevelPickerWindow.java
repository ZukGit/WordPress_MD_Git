...
public class Area_MultiLevelPickerWindow<T extends Stock_Node> extends PopupWindow {
    ...
    public Area_MultiLevelItemAdapter<T> mAdapter1, mAdapter2, mAdapter3;
    ...
    public Area_MultiLevelPickerWindow(Context context , int colorId) {
        mBGColorId = colorId;
        init(context);
    }
    ...
    private void init(final Context context) {
        ...
        mRootView = LayoutInflater.from(context).inflate(
                R.layout.stock_area_window_picker, null);
        mcontext = context;
        buildView(mRootView);
...
if(mAdapter3 !=  null){
    ...
    private void buildView(View view) {
        Log.i("zukgit", "════════════════════════════ AreaMultiLevelPickerWindow_______buildView() Begin════════════════════════════");
...
/*        rv1.setBackgroundColor(mBGColorId);
        ...
        mAdapter1 = new Area_MultiLevelItemAdapter<>(null, 0,mcontext,this,1);
        ...
        mAdapter2 = new Area_MultiLevelItemAdapter<>(null, 1,mcontext,this,2);
        ...
        mAdapter3 = new  Area_MultiLevelItemAdapter<>(null, 2,mcontext,this,3);
...
/*        view.findViewById(R.id.btnclose).setOnClickListener(v -> dismiss());
    ...
    public boolean updateData(T t) {
        ...
        if (storage[1] < 0) { // 表示本来就没选择二级菜单
          //  mAdapter2.setNewData(null);  没有选中第二级菜单  仍然显示第二季菜单
            mAdapter3.setNewData(null);
