...
public class Img_Common_Port_Fragment extends BaseFragment {
...
//        adapter = new ImgAdapter(getActivity(), DataCreate.datas);
    JpgAdapter = new JPGAdapter(getActivity(),DataHolder.Common_Img_Port_random_indexlist,DataHolder.Common_Img_Port_file_list);
...
// s少时诵诗书所
        ...
        //监听播放或暂停事件
        RxBus.getDefault().toObservable(Pause_Img_Common_Port_Event.class)
                .subscribe((Action1<Pause_Img_Common_Port_Event>) event -> {
                    if (event.isPlayOrPause()) {
                        android.util.Log.i("zukgit", "curPlayPos = " + curPlayPos + " ImgCommonPortFragment.init B   ");
                        mDoubleTap_ScaleNum_Index = 0;
                        android.util.Log.i("zukgit", "AA toObservable  DataHolder.Common_Img_Port_initPos = " + DataHolder.Common_Img_Port_initPos + " pause_Img(true)   ");
                        if(recyclerView != null){
                            recyclerView.scrollToPosition(DataHolder.Common_Img_Port_initPos);
                            android.util.Log.i("zukgit", "AA toObservable  DataHolder.Common_Img_Port_initPos = " + DataHolder.Common_Img_Port_initPos + " pause_Img(true)   ");
                        }
                        pause_Img(false);
                        ...
                        android.util.Log.i("zukgit", "BB toObservable  DataHolder.Common_Img_Port_initPos = " + DataHolder.Common_Img_Port_initPos + " pause_Img(true)   ");
                        pause_Img(true);
                    }
                });
        pause_Img(true);
    ...
    public void onResume() {
        super.onResume();
        android.util.Log.i("zukgit", "curPlayPos = " + curPlayPos + " ImgCommonPortFragment.onResume  A   MainActivity.curMainPage =" + MainActivity.curMainPage + "  MainFragment.curPage =" + MainFragment.curPage);
...
/*        //返回时，推荐页面可见，则继续播放视频
        ...
        android.util.Log.i("zukgit", "curPlayPos = " + curPlayPos + " ImgCommonPortFragment.onResume  CB ");
        android.util.Log.i("zukgit", "curPlayPos = " + curPlayPos + " ImgCommonPortFragment.onResume  D ");
        InputMethodManager imm = (InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.hideSoftInputFromWindow(getActivity().getWindow().getDecorView().getWindowToken(), 0);

        android.util.Log.i("zukgit", "ImgCommonPortFragment  hideSoftInputFromWindow FF ");
    ...
    private void setViewPagerLayoutManager() {
        ...
        viewPagerLayoutManager.setOnViewPagerListener(new OnViewPagerListener() {
            ...
            public void onInitComplete() {
                ...
                File jiemiFile = EncryUtil.createDecryByteData(DataHolder.Common_Img_Port_file_list[DataHolder.Common_Img_Port_random_indexlist.get(DataHolder.Common_Img_Port_initPos%DataHolder.Common_Img_Port_count)]);
                Uri uri_item = Uri.fromFile(jiemiFile);
                android.util.Log.i("zukgit", "onInitComplete ivCover.setImageURI    curPlayPos =" + curPlayPos + "DataHolder.Common_Img_Port_initPos ="+ DataHolder.Common_Img_Port_initPos + "uri_item = "+ uri_item.toString());

                playCurImg(DataHolder.Common_Img_Port_initPos);
            }
            ...
            public void onPageSelected(int position, boolean isBottom) {
                ...
                android.util.Log.i("zukgit", "X1 ImgFragment.onPageSelected.curPlayPos = " + curPlayPos + " position  =   " + position + " DataHolder.Common_Img_Port_initPos  =   " + DataHolder.Common_Img_Port_initPos + " isBottom = " + isBottom);
...
//                    int step = curPlayPos - position;
                    DataHolder.Common_Img_Port_initPos = DataHolder.Common_Img_Port_initPos - 1;
...
//                    int step = position - curPlayPos;
                ...
                if (DataHolder.Common_Img_Port_initPos < 0 || position == 0) {
                    DataHolder.Common_Img_Port_initPos = 0;
                }
                DataHolder.Common_Img_Port_initPos = position;
                curPlayPos = DataHolder.Common_Img_Port_initPos;
                android.util.Log.i("zukgit", "X2  ImgFragment.onPageSelected.curPlayPos = " + curPlayPos + " position  =   " + position + " DataHolder.Common_Img_Port_initPos  =   " + DataHolder.Common_Img_Port_initPos + " user_backup_num = " + user_backup_num);
...
//        String fileName = getTimeStamp() + "_" + Img_file_list[DataHolder.Img_random_indexlist.get(position)].getName();
//        File jiemiFile = new File(video_file_list[0].getParentFile().getAbsolutePath()+File.separator+fileName);
//        File jiemiFile = EncryUtil.createDecryByteData(DataHolder.Img_file_list[DataHolder.Img_random_indexlist.get(position)]);
        File jiemiFile = DataHolder.Common_Img_Port_file_list[DataHolder.Common_Img_Port_random_indexlist.get(position%DataHolder.Common_Img_Port_count)];



        Uri uri_item = Uri.fromFile(jiemiFile);
        android.util.Log.i("zukgit", "ivCover.setImageURI  position ="+ position + "   DataHodler.ImgiIndex="+DataHolder.Common_Img_Port_initPos + "   Img Pre  =" + uri_item.toString());
...
/*
        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                DataHolder.Common_Img_Port_initPos++;
                curPlayPos = DataHolder.Common_Img_Port_initPos;
//                android.util.Log.i("zukgit","B curPlayPos = "+ curPlayPos);
                android.util.Log.i("zukgit", "X2  Img_Common_Fragment.onPageSelected.curPlayPos = " + curPlayPos + " position  =   " + position + " DataHolder.Common_Img_Port_initPos  =   " + DataHolder.Common_Img_Port_initPos);

                videoView.stopPlayback();
//                autoShowImg(curPlayPos, ivCover);
                autoShowImg(DataHolder.Common_Img_Port_initPos);
            }
        });*/
...
/*    void wait_1second_operation(){
    ...
    new CountDownTimer(1000, 500) {
        ...
        @Override
        public void onFinish() {
            if(curPlayPos == DataHolder.Common_Img_Port_initPos){
                pause_Img(false);
            }
        }
    }.start();
    ...
    void gotoNextPage_loop(boolean imediate){
        ...
        if(!isImgPause){
            ...
            if(imediate){
                DataHolder.Common_Img_Port_initPos++;
                android.util.Log.i("zukgit", "AA DataHolder.Common_Img_Port_initPos   DataHolder.Common_Img_Port_initPos = " + DataHolder.Common_Img_Port_initPos);
                recyclerView.scrollToPosition(DataHolder.Common_Img_Port_initPos);
            }
            if(loopPlay_Timer != null){
                loopPlay_Timer.cancel();
            ...
            loopPlay_Timer =    new CountDownTimer(3500, 500) {
                ...
                public void onFinish() {
                    ...
                    if(!isImgPause) {
                        DataHolder.Common_Img_Port_initPos++;
                        onFinish_num++;
                        android.util.Log.i("zukgit", "【"+onFinish_num+ "】 = onFinish_num   DataHolder.Common_Img_Port_initPos   DataHolder.Common_Img_Port_initPos = " + DataHolder.Common_Img_Port_initPos);
//                    playCurImg(DataHolder.Common_Img_Port_initPos);
//                        recyclerView.scrollToPosition(DataHolder.Common_Img_Port_initPos);
                        ...
                        recyclerView.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                recyclerView.smoothScrollToPosition(DataHolder.Common_Img_Port_initPos);
        ...
        alterDiaglog.setNeutralButton("删除", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(fileIndex == 0){
                    ...
                    DataHolder.Common_Img_Port_file_list[DataHolder.Common_Img_Port_random_indexlist.get((fileIndex)%DataHolder.Common_Img_Port_count)] =      DataHolder.Common_Img_Port_file_list[DataHolder.Common_Img_Port_random_indexlist.get((fileIndex+1)%DataHolder.Common_Img_Port_count)];


                } else      if(fileIndex > 0 && fileIndex < DataHolder.Common_Img_Port_file_list.length){
