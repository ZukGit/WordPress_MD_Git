...
public class F2_DownFile_AOSP {
    ...
    static File F2File = new File(System.getProperties().getProperty("user.home") + File.separator + "Desktop" + File.separator + "zbin" + File.separator + "F2_AOSP_File");
    static String AOSP_FILE_SITE4_1 = "https://www.androidos.net.cn/android/";  //  第一部分  网址
    static String Prefix4_3 = "/download";  // 前缀 第三部分
    ...
    static void showAllVersionInfo() {
        ...
        for (int i = 0; i < allFileList.size(); i++) {
            ...
            for (int j = 0; j < fileItem.allJavaFileList.size(); j++) {
                ...
                fileItemListLog.add("url:"+javaItem.mdownloadUrl);
                fileItemListLog.add(":===============");
            }
    ...
    static class FilePath_ITEM {
        ...
        FilePath_ITEM(String AOSPPath) {
            ...
            for (int i = 0; i < aospList.size(); i++) {
                ...
                String absPath = F2File.getAbsolutePath() + File.separator + this.mfileName_lower + File.separator + mAndroidVersionFixed + this.mfileName_common + mAndroidNameTagFixed + "." + this.mFileType;

               JavaFile_Item javaFile = new JavaFile_Item( absPath , downloadPath , versionTagChar ,api ,  androidVersion );
        ...
        static class JavaFile_Item {
           ...
           JavaFile_Item(String absPath , String downloadUrl  , char versionNickChar , int api , double version){
               this.targetJavaFilePath = absPath;
               this.mdownloadUrl = downloadUrl;
               this.targetJavaFile = new File(absPath);
               this.isfile_exist = targetJavaFile.exists();
