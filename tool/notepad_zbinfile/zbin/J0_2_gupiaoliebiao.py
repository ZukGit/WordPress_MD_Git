...
stock_basic_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0\\C:\\Users\\zhuzj5\\Desktop\\zbin\\J0\\股票列表.xlsx')
...
print("stock_basic_item_0 返回数据 row 行数 = "+str(stock_basic_item_0.shape[0]))
...
print("stock_basic_item_1 返回数据 row 行数 = "+str(stock_basic_item_1.shape[0]))
...
print("stock_basic_item_2 返回数据 row 行数 = "+str(stock_basic_item_2.shape[0]))
...
print("stock_basic_item_3 返回数据 row 行数 = "+str(stock_basic_item_3.shape[0]))
...
print("stock_basic_item_4 返回数据 row 行数 = "+str(stock_basic_item_4.shape[0]))
...
print("stock_basic_item_5 返回数据 row 行数 = "+str(stock_basic_item_5.shape[0]))
...
print("stock_basic_item_6 返回数据 row 行数 = "+str(stock_basic_item_6.shape[0]))
...
print("stock_basic_item_7 返回数据 row 行数 = "+str(stock_basic_item_7.shape[0]))
...
print("stock_basic_item_8 返回数据 row 行数 = "+str(stock_basic_item_8.shape[0]))
...
print("stock_basic_item_9 返回数据 row 行数 = "+str(stock_basic_item_9.shape[0]))
...
print("stock_basic_item_10 返回数据 row 行数 = "+str(stock_basic_item_10.shape[0]))
...
print("stock_basic_item_11 返回数据 row 行数 = "+str(stock_basic_item_11.shape[0]))
...
print("stock_basic_item_12 返回数据 row 行数 = "+str(stock_basic_item_12.shape[0]))
...
print("stock_basic_item_13 返回数据 row 行数 = "+str(stock_basic_item_13.shape[0]))
...
print("stock_basic_item_14 返回数据 row 行数 = "+str(stock_basic_item_14.shape[0]))
...
print("stock_basic_item_15 返回数据 row 行数 = "+str(stock_basic_item_15.shape[0]))
...
print("stock_basic_item_16 返回数据 row 行数 = "+str(stock_basic_item_16.shape[0]))
...
print("stock_basic_item_17 返回数据 row 行数 = "+str(stock_basic_item_17.shape[0]))
...
print("stock_basic_item_18 返回数据 row 行数 = "+str(stock_basic_item_18.shape[0]))
...
print("stock_basic_item_19 返回数据 row 行数 = "+str(stock_basic_item_19.shape[0]))
...
print("stock_basic_item_20 返回数据 row 行数 = "+str(stock_basic_item_20.shape[0]))
...
print("stock_basic_item_21 返回数据 row 行数 = "+str(stock_basic_item_21.shape[0]))
...
print("stock_basic_item_22 返回数据 row 行数 = "+str(stock_basic_item_22.shape[0]))
...
print("stock_basic_item_23 返回数据 row 行数 = "+str(stock_basic_item_23.shape[0]))
...
print("stock_basic_item_24 返回数据 row 行数 = "+str(stock_basic_item_24.shape[0]))
...
print("stock_basic_item_25 返回数据 row 行数 = "+str(stock_basic_item_25.shape[0]))
...
print("stock_basic_item_26 返回数据 row 行数 = "+str(stock_basic_item_26.shape[0]))
