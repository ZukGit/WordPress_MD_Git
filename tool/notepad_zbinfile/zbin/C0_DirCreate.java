...
public class C0_DirCreate {
    ...
    static {
        ...
        patList_g.add("g" + File.separator + "temp6");
        ...
        patList_v.add("v");
        patList_g.add("v" + File.separator + "temp1_1");
        patList_g.add("v" + File.separator + "temp2_1");
        patList_g.add("v" + File.separator + "temp3_1");
        patList_g.add("v" + File.separator + "temp4_1");
        patList_g.add("v" + File.separator + "temp5_1");
        patList_g.add("v" + File.separator + "temp6_1");
        patList_g.add("v" + File.separator + "temp7_1");
        patList_g.add("v" + File.separator + "temp8_1");
        ...
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp1_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp2_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp3_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp4_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp5_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp6_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp7_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp8_1");
        patList_v.add("v" + File.separator + "ym"+ File.separator + "temp9_1");
        ...
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp1_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp2_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp3_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp4_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp5_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp6_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp7_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp8_1");
        patList_v.add("v" + File.separator + "wm"+ File.separator + "temp9_1");
