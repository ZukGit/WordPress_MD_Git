     ...
     /*               "\n"+Cur_Bat_Name+ " *_14  .mp4         ### 源文件被按顺序重命名 1_ 2_动态计算当前文件夹中所有子文件中的mp4文件 并在当前目录生成 MP4_20200522_154600 字样的文件夹 \n"+
        ...
        void operationRule(ArrayList<String> inputParamsList){
            ...
            for (int i = 0; i < inputParamsList.size(); i++) {
                ...
                ArrayList<Integer>  rgb_list = calculInputColor_width_high(rgb_arr);
...
//            String date = df.format(new Date());// new Date()为获取当前系统时间，也可使用当前时间戳
            ...
            for (int i = 0; i < colorList.size(); i++) {
                ...
                System.out.println("R_G_B_W_H = "+r+"_"+g+"_"+b+"_"+width+"_"+high+" = "+r_hex+"_"+g_hex+"_"+b_hex+"_"+width+"_"+high );
                if(i == 0){
     ...
     /*               "\n"+Cur_Bat_Name+ " *_14  .mp4         ### 源文件被按顺序重命名 1_ 2_动态计算当前文件夹中所有子文件中的mp4文件 并在当前目录生成 MP4_20200522_154600 字样的文件夹 \n"+
        ...
        void operationRule(ArrayList<String> inputParamsList){
            ...
            for (int i = 0; i < inputParamsList.size(); i++) {
               ...
               ArrayList<Integer>  rgb_list = calculInputColor(rgb_arr);
...
//            String date = df.format(new Date());// new Date()为获取当前系统时间，也可使用当前时间戳
            ...
            for (int i = 0; i < colorList.size(); i++) {
                ...
                System.out.println("R_G_B = "+r+"_"+g+"_"+b+" = "+r_hex+"_"+g_hex+"_"+b_hex );
                if(i == 0){
                    openImageFile(curRGBFile);
                }
    ...
    static ArrayList<Integer> calculInputColor_width_high(String[] inputStrArr){
        ...
        for (int i = 0; i < inputStrArr.length; i++) {
            ...
            if(isNumeric(color_value)){   //  10 进制
...
static ArrayList<Integer> calculInputColor(String[] inputStrArr){
    ArrayList<Integer> rgb_list = new  ArrayList<Integer>();
