...
// 3. 以类为单位进行划分   流程指定自身需要的该类的哪个ZMethod(指定 methodIdentify)
    ...
    static Set<File> allSimpleJavaFileSet = new HashSet<>();   // 当前工程下所有非文件夹的 Java文件
